            ...
            switch (Uszka.Kernel.langSelected)
            {
                case "fr_FR":
                    ...
                    switch (ToTranslate)
                    {
                        ...
                        case "about":
                            ...
                            Console.WriteLine("Aura [version " + Uszka.Kernel.version + "-" + Uszka.Kernel.revision + "]");
                        ...
                        case "changeipaddress":
                            Console.WriteLine("Nouvelle adresse IP du PC (actuellement " + Uszka.Kernel.LocalNetworkConfig.IPAddress.ToString() + ") :");
                            break;
                ...
                case "en_US":
                    ...
                    switch (ToTranslate)
                    {
                        ...
                        case "time":
                            ...
                            break;
                        case "changeipaddress":
                            Console.WriteLine("New IP address of the PC (now " + Uszka.Kernel.LocalNetworkConfig.IPAddress.ToString() + ") :");
                            break;
                        case "notcorrectaddress":
                ...
                case "nl_NL":
                    ...
                    switch (ToTranslate)
                    {
                        ...
                        case "about":
                            Console.ForegroundColor = ConsoleColor.White;
                            Console.WriteLine("Aura [versie " + Uszka.Kernel.version + "-" + Uszka.Kernel.revision + "]");
                        ...
                        case "time":
                            ...
                            break;
                        case "changeipaddress":
                            Console.WriteLine("Nieuw IP-adres van de PC (nu " + Uszka.Kernel.LocalNetworkConfig.IPAddress.ToString() + ") :");
                            break;
                        case "notcorrectaddress":
                ...
                case "it_IT":
                    ...
                    switch (ToTranslate)
                    {
                        ...
                        case "about":
                            Console.ForegroundColor = ConsoleColor.White;
                            Console.WriteLine("Aura [Versione " + Uszka.Kernel.version + "-" + Uszka.Kernel.revision + "]");
                        ...
                        case "time":
                            ...
                            break;
                        case "changeipaddress":
                            Console.WriteLine("Nuovo indirizzo IP del PC (ora " + Uszka.Kernel.LocalNetworkConfig.IPAddress.ToString() + ") :");
                            break;
                        case "notcorrectaddress":
