...
namespace Aura_OS.System
{
    public class Crash
    {
        ...
        /// <summary>
        /// Stop the Uszka.Kernel and display exception
        /// </summary>
        /// <param name="ex">Exception that stop the Uszka.Kernel</param>
        public static void StopKernal(Exception ex)
        {

            Uszka.Kernel.running = false;
            ...
            Uszka.Kernel.AConsole.Clear(0xFFAA0000);

            Uszka.Kernel.AConsole.X = 0;
            Uszka.Kernel.AConsole.Y = 0;
            ...
            Console.WriteLine("Aura Version: " + Uszka.Kernel.version);
            Console.WriteLine("Aura Revision: " + Uszka.Kernel.revision);
            Console.WriteLine();
