...
namespace Aura_OS.System
{
    class Setup
    {
        ...
        public void InitSetup()
        {
            ...
            {
                Uszka.Kernel.SystemExists = true;
            }
        ...
        public void RunWithoutFS(bool nofsroot) //logged with root without using filesystem
        {
            ...
            Uszka.Kernel.SystemExists = false;
            Uszka.Kernel.userLogged = "root";
            Uszka.Kernel.Logged = true;
            Console.Clear();
            //switch (Video.GetVideo())
            //{
            //    case "VGATextmode":
            //        //Uszka.Kernel.AConsole = new System.Shell.VGA.VGAConsole(null);
            //        break;
            //    case "SVGA":
            //        // TO DO ?
            //        break;
            //    case "VESA":
            //        //Uszka.Kernel.AConsole = new System.Shell.VESAVBE.VESAVBEConsole();
            //        break;
            //    default:
            //        //Uszka.Kernel.AConsole = new System.Shell.VGA.VGAConsole(null);
            //        break;
        ...
        public void Run()
        {
            ...
            Uszka.Kernel.userLogged = username;
            Uszka.Kernel.JustInstalled = true;
            Uszka.Kernel.running = true;
